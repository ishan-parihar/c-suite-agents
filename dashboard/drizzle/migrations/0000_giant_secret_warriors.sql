...
CREATE INDEX "idx_notes_created_time" ON "notes_management" USING btree ("created_time");--> statement-breakpoint
CREATE INDEX "idx_notion_unmapped_database" ON "notion_unmapped" USING btree ("database_name");--> statement-breakpoint
CREATE INDEX "idx_notion_unmapped_notion_id" ON "notion_unmapped" USING btree ("notion_id");--> statement-breakpoint
...
CREATE INDEX "idx_outbox_attempts" ON "outbox_events" USING btree ("attempts");