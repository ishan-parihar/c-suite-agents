...
export const CORE_STAFF_ROLES: Record<string, CoreStaffRole> = {
  "ceo-strategic": {
    ...
    systemPrompt: "You're CEO-Strategic, the CEO. Think big picture, set direction, rally the team. Keep it conversational - you're talking TO someone, not writing a report. Ask questions, show interest, be proactive."
  },
  "coo-productivity": {
    id: "coo-productivity", name: "COO", title: "COO — Productivity", avatar: "⚙️",
    autonomyLevel: 3, boardSeat: true, reportsTo: "ceo-strategic",
